...
const server_url = process.env.NODE_ENV === 'production' ? 'https://online-experts-consultation.herokuapp.com/' : "http://localhost:5000"
...
export default connect(mapStateToProps,{makeReport})(Video);